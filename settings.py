...
SECRET_KEY = 'django-insecure-)b54-7*9zyi)!7+yr-_y4+94bmsz-idrf)o6ikd_6ejm_5ij&r'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'hotel/templates'],  # Add this line to ensure it can find the templates
        # 'DIRS': [],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
ASGI_APPLICATION = 'HotelManagementSystem.asgi.application'
